...
df_etfs = openxlsx::read.xlsx(xlsxFile = "~/Dropbox/R/money-printer-go-brrr/vignettes/Data/etf_list.xlsx")
...
```{r}
df_top_market_cap = read.csv(file = "~/Dropbox/R/money-printer-go-brrr/vignettes/Data/nasdaq_screener_1649872205540.csv") %>% 
